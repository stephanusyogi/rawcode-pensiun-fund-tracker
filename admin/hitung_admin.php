...
for($i=1;$i<=$jml_port_personal;$i++){
  ...
  $return_personal_tranche1[$i]= $komposisi_inv_saham_personal[$i]*$return_saham_personal[$i] + $komposisi_inv_fi_personal[$i]*$return_fi_personal[$i] + $komposisi_inv_depo_personal[$i]*$return_depo_personal[$i]; // perhitungan return portofolio tranche investasi
