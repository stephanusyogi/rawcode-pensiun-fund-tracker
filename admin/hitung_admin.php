...
for($i=1;$i<=$jml_port_ppip;$i++){
  ...
  //Output: Create $return_ppip_inv[$i], $return_ppip_likuid[$i], $risk_ppip_inv[$i], dan $risk_ppip_likuid[$i]
}
...
for($i=1;$i<=$jml_port_personal;$i++){
  ...
  $risk_personal_tranche1[$i]=sqrt($risk_personal_tranche1_step1[$i]+$risk_personal_tranche1_step2[$i]+$risk_personal_tranche1_step3[$i]+$risk_personal_tranche1_step4[$i]+$risk_personal_tranche1_step5[$i]+$risk_personal_tranche1_step6[$i]+$risk_personal_tranche1_step7[$i]);// risiko all
  
  //==============================================
  //untuk tranche 2
   
  $return_saham_personal_tranche2[$i]=0.13; //Read return saham
  $return_fi_personal_tranche2[$i]=0.13; //Read return pendapatan tetap
  $return_depo_personal_tranche2[$i]=0.13; //Read return deposito
  $return_rdsaham_personal_tranche2[$i]=0.13; //Read return reksadana saham
  $return_rdfi_personal_tranche2[$i]=0.13; //Read return reksadana pendapatan tetap
  $return_rdpu_personal_tranche2[$i]=0.13; //Read return reksadana pasar uang
  $return_rdcampuran_personal_tranche2[$i]=0.13; //Read return reksadana campuran
  
  $risk_saham_personal_tranche2[$i]=0.13; //Read risk saham
  $risk_fi_personal_tranche2[$i]=0.13; //Read risk pendapatan tetap
  $risk_depo_personal_tranche2[$i]=0.13; //Read risk deposito
  $risk_rdsaham_personal_tranche2[$i]=0.13; //Read risk reksadana saham
  $risk_rdfi_personal_tranche2[$i]=0.13; //Read risk reksadanapendapatan tetap
  $risk_rdpu_personal_tranche2[$i]=0.13; //Read risk reksadana pasar uang
  $risk_rdcampuran_personal_tranche2[$i]=0.13; //Read risk reksadana campuran
  
  $korel_saham_fi_personal_tranche2[$i]=0.13; //Read korelasi saham - pendapatan tetap
  $korel_saham_depo_personal_tranche2[$i]=0.13; //Read korelasi saham - deposito
  $korel_saham_rdsaham_personal_tranche2[$i]=0.13; //Read korelasi saham - rdsaham
  $korel_saham_rdfi_personal_tranche2[$i]=0.13; //Read korelasi saham - rdfi
  $korel_saham_rdpu_personal_tranche2[$i]=0.13; //Read korelasi saham - rdpu
  $korel_saham_rdcampuran_personal_tranche2[$i]=0.13; //Read korelasi saham - rdsaham
  
  $korel_fi_depo_personal_tranche2[$i]=0.13; //Read korelasi fi - deposito
  $korel_fi_rdsaham_personal_tranche2[$i]=0.13; //Read korelasi fi - rdsaham
  $korel_fi_rdfi_personal_tranche2[$i]=0.13; //Read korelasi fi - rdfi
  $korel_fi_rdpu_personal_tranche2[$i]=0.13; //Read korelasi fi - rdpu
  $korel_fi_rdcampuran_personal_tranche2[$i]=0.13; //Read korelasi fi - rdsaham
  
  $korel_depo_rdsaham_personal_tranche2[$i]=0.13; //Read korelasi depo - rdsaham
  $korel_depo_rdfi_personal_tranche2[$i]=0.13; //Read korelasi depo - rdfi
  $korel_depo_rdpu_personal_tranche2[$i]=0.13; //Read korelasi depo - rdpu
  $korel_depo_rdcampuran_personal_tranche2[$i]=0.13; //Read korelasi depo - rdsaham
  
  $korel_rdsaham_rdfi_personal_tranche2[$i]=0.13; //Read korelasi rdsaham - rdfi
  $korel_rdsaham_rdpu_personal_tranche2[$i]=0.13; //Read korelasi rdsaham - rdpu
  $korel_rdsaham_rdcampuran_personal_tranche2[$i]=0.13; //Read korelasi rdsaham - rdsaham

  $korel_rdfi_rdpu_personal_tranche2[$i]=0.13; //Read korelasi rdfi - rdpu
  $korel_rdfi_rdcampuran_personal_tranche2[$i]=0.13; //Read korelasi rdfi - rdsaham
  
  $korel_rdpu_rdcampuran_personal_tranche2[$i]=0.13; //Read korelasi rdpu - rdsaham
  ...
  $return_personal_tranche2[$i]= $komposisi_tranche2_saham_personal[$i]*$return_saham_personal_tranche2[$i] + $komposisi_tranche2_fi_personal[$i]*$return_fi_personal_tranche2[$i] + $komposisi_tranche2_depo_personal[$i]*$return_depo_personal_tranche2[$i]+ $komposisi_tranche2_rdsaham_personal[$i]*$return_rdsaham_personal_tranche2[$i]+ $komposisi_tranche2_rdfi_personal[$i]*$return_rdfi_personal_tranche2[$i]+ $komposisi_tranche2_rdpu_personal[$i]*$return_rdpu_personal_tranche2[$i]+ $komposisi_tranche2_rdcampuran_personal[$i]*$return_rdcampuran_personal_tranche2[$i]; // perhitungan return portofolio tranche 2
  
  $risk_personal_tranche2_step1[$i]= $komposisi_tranche2_saham_personal[$i]*$risk_saham_personal_tranche2[$i]* $komposisi_tranche2_saham_personal[$i]*$risk_saham_personal_tranche2[$i] + $komposisi_tranche2_fi_personal[$i]*$risk_fi_personal_tranche2[$i]* $komposisi_tranche2_fi_personal[$i]*$risk_fi_personal_tranche2[$i] + $komposisi_tranche2_depo_personal[$i]*$risk_depo_personal_tranche2[$i]* $komposisi_tranche2_depo_personal[$i]*$risk_depo_personal_tranche2[$i]+ $komposisi_tranche2_rdsaham_personal[$i]*$risk_rdsaham_personal_tranche2[$i]* $komposisi_tranche2_rdsaham_personal[$i]*$risk_rdsaham_personal_tranche2[$i]+ $komposisi_tranche2_rdfi_personal[$i]*$risk_rdfi_personal_tranche2[$i]* $komposisi_tranche2_rdfi_personal[$i]*$risk_rdfi_personal_tranche2[$i]+ $komposisi_tranche2_rdpu_personal[$i]*$risk_rdpu_personal_tranche2[$i]* $komposisi_tranche2_rdpu_personal[$i]*$risk_rdpu_personal_tranche2[$i]+ $komposisi_tranche2_rdcampuran_personal[$i]*$risk_rdcampuran_personal_tranche2[$i]* $komposisi_tranche2_rdcampuran_personal[$i]*$risk_rdcampuran_personal_tranche2[$i]; // perhitungan risk portofolio tranche 2 step 2
  $risk_personal_tranche2_step2[$i]= 2*$komposisi_tranche2_saham_personal[$i]*$risk_saham_personal_tranche2[$i]* $komposisi_tranche2_fi_personal[$i]*$risk_fi_personal_tranche2[$i]* $korel_saham_fi_personal_tranche2[$i] + 2*$komposisi_tranche2_saham_personal[$i]*$risk_saham_personal_tranche2[$i]* $komposisi_tranche2_depo_personal[$i]*$risk_depo_personal_tranche2[$i]* $korel_saham_depo_personal_tranche2[$i] + 2*$komposisi_tranche2_saham_personal[$i]*$risk_saham_personal_tranche2[$i]* $komposisi_tranche2_rdsaham_personal[$i]*$risk_rdsaham_personal_tranche2[$i]* $korel_saham_rdsaham_personal_tranche2[$i] + 2*$komposisi_tranche2_saham_personal[$i]*$risk_saham_personal_tranche2[$i]* $komposisi_tranche2_rdfi_personal[$i]*$risk_rdfi_personal_tranche2[$i]* $korel_saham_rdfi_personal_tranche2[$i] + 2*$komposisi_tranche2_saham_personal[$i]*$risk_saham_personal_tranche2[$i]* $komposisi_tranche2_rdpu_personal[$i]*$risk_rdpu_personal_tranche2[$i]* $korel_saham_rdpu_personal_tranche2[$i] + 2*$komposisi_tranche2_saham_personal[$i]*$risk_saham_personal_tranche2[$i]* $komposisi_tranche2_rdcampuran_personal[$i]*$risk_rdcampuran_personal_tranche2[$i]* $korel_saham_rdcampuran_personal_tranche2[$i]; // perhitungan risk portofolio tranche 2 step 2
  $risk_personal_tranche2_step3[$i]= 2*$komposisi_tranche2_fi_personal[$i]*$risk_fi_personal_tranche2[$i]* $komposisi_tranche2_depo_personal[$i]*$risk_depo_personal_tranche2[$i]* $korel_fi_depo_personal_tranche2[$i] + 2*$komposisi_tranche2_fi_personal[$i]*$risk_fi_personal_tranche2[$i]* $komposisi_tranche2_rdsaham_personal[$i]*$risk_rdsaham_personal_tranche2[$i]* $korel_fi_rdsaham_personal_tranche2[$i] + 2*$komposisi_tranche2_fi_personal[$i]*$risk_fi_personal_tranche2[$i]* $komposisi_tranche2_rdfi_personal[$i]*$risk_rdfi_personal_tranche2[$i]* $korel_fi_rdfi_personal_tranche2[$i] + 2*$komposisi_tranche2_fi_personal[$i]*$risk_fi_personal_tranche2[$i]* $komposisi_tranche2_rdpu_personal[$i]*$risk_rdpu_personal_tranche2[$i]* $korel_fi_rdpu_personal_tranche2[$i] + 2*$komposisi_tranche2_fi_personal[$i]*$risk_fi_personal_tranche2[$i]* $komposisi_tranche2_rdcampuran_personal[$i]*$risk_rdcampuran_personal_tranche2[$i]* $korel_fi_rdcampuran_personal_tranche2[$i]; // perhitungan risk portofolio tranche 2 step 3
  $risk_personal_tranche2_step4[$i]= 2*$komposisi_tranche2_depo_personal[$i]*$risk_depo_personal_tranche2[$i]* $komposisi_tranche2_rdsaham_personal[$i]*$risk_rdsaham_personal_tranche2[$i]* $korel_depo_rdsaham_personal_tranche2[$i] + 2*$komposisi_tranche2_depo_personal[$i]*$risk_depo_personal_tranche2[$i]* $komposisi_tranche2_rdfi_personal[$i]*$risk_rdfi_personal_tranche2[$i]* $korel_depo_rdfi_personal_tranche2[$i] + 2*$komposisi_tranche2_depo_personal[$i]*$risk_depo_personal_tranche2[$i]* $komposisi_tranche2_rdpu_personal[$i]*$risk_rdpu_personal_tranche2[$i]* $korel_depo_rdpu_personal_tranche2[$i] + 2*$komposisi_tranche2_depo_personal[$i]*$risk_depo_personal_tranche2[$i]* $komposisi_tranche2_rdcampuran_personal[$i]*$risk_rdcampuran_personal_tranche2[$i]* $korel_depo_rdcampuran_personal_tranche2[$i]; // perhitungan risk portofolio tranche 2 step 4
  $risk_personal_tranche2_step5[$i]= 2*$komposisi_tranche2_rdsaham_personal[$i]*$risk_rdsaham_personal_tranche2[$i]* $komposisi_tranche2_rdfi_personal[$i]*$risk_rdfi_personal_tranche2[$i]* $korel_rdsaham_rdfi_personal_tranche2[$i] + 2*$komposisi_tranche2_rdsaham_personal[$i]*$risk_rdsaham_personal_tranche2[$i]* $komposisi_tranche2_rdpu_personal[$i]*$risk_rdpu_personal_tranche2[$i]* $korel_rdsaham_rdpu_personal_tranche2[$i] + 2*$komposisi_tranche2_rdsaham_personal[$i]*$risk_rdsaham_personal_tranche2[$i]* $komposisi_tranche2_rdcampuran_personal[$i]*$risk_rdcampuran_personal_tranche2[$i]* $korel_rdsaham_rdcampuran_personal_tranche2[$i]; // perhitungan risk portofolio tranche 2 step 5
  $risk_personal_tranche2_step6[$i]= 2*$komposisi_tranche2_rdfi_personal[$i]*$risk_rdfi_personal_tranche2[$i]* $komposisi_tranche2_rdpu_personal[$i]*$risk_rdpu_personal_tranche2[$i]* $korel_rdfi_rdpu_personal_tranche2[$i] + 2*$komposisi_tranche2_rdfi_personal[$i]*$risk_rdfi_personal_tranche2[$i]* $komposisi_tranche2_rdcampuran_personal[$i]*$risk_rdcampuran_personal_tranche2[$i]* $korel_rdfi_rdcampuran_personal_tranche2[$i]; // perhitungan risk portofolio tranche 2 step 6
  $risk_personal_tranche2_step7[$i]= 2*$komposisi_tranche2_rdpu_personal[$i]*$risk_rdpu_personal_tranche2[$i]* $komposisi_tranche2_rdcampuran_personal[$i]*$risk_rdcampuran_personal_tranche2[$i]* $korel_rdpu_rdcampuran_personal_tranche2[$i]; // perhitungan risk portofolio tranche 2 step 7
  $risk_personal_tranche2[$i]=sqrt($risk_personal_tranche2_step1[$i]+$risk_personal_tranche2_step2[$i]+$risk_personal_tranche2_step3[$i]+$risk_personal_tranche2_step4[$i]+$risk_personal_tranche2_step5[$i]+$risk_personal_tranche2_step6[$i]+$risk_personal_tranche2_step7[$i]);// risiko all

  //==============================================
  //untuk tranche 3
   
  $return_saham_personal_tranche3[$i]=0.13; //Read return saham
  $return_fi_personal_tranche3[$i]=0.13; //Read return pendapatan tetap
  $return_depo_personal_tranche3[$i]=0.13; //Read return deposito
  $return_rdsaham_personal_tranche3[$i]=0.13; //Read return reksadana saham
  $return_rdfi_personal_tranche3[$i]=0.13; //Read return reksadana pendapatan tetap
  $return_rdpu_personal_tranche3[$i]=0.13; //Read return reksadana pasar uang
  $return_rdcampuran_personal_tranche3[$i]=0.13; //Read return reksadana campuran
  
  $risk_saham_personal_tranche3[$i]=0.13; //Read risk saham
  $risk_fi_personal_tranche3[$i]=0.13; //Read risk pendapatan tetap
  $risk_depo_personal_tranche3[$i]=0.13; //Read risk deposito
  $risk_rdsaham_personal_tranche3[$i]=0.13; //Read risk reksadana saham
  $risk_rdfi_personal_tranche3[$i]=0.13; //Read risk reksadanapendapatan tetap
  $risk_rdpu_personal_tranche3[$i]=0.13; //Read risk reksadana pasar uang
  $risk_rdcampuran_personal_tranche3[$i]=0.13; //Read risk reksadana campuran
  
  $korel_saham_fi_personal_tranche3[$i]=0.13; //Read korelasi saham - pendapatan tetap
  $korel_saham_depo_personal_tranche3[$i]=0.13; //Read korelasi saham - deposito
  $korel_saham_rdsaham_personal_tranche3[$i]=0.13; //Read korelasi saham - rdsaham
  $korel_saham_rdfi_personal_tranche3[$i]=0.13; //Read korelasi saham - rdfi
  $korel_saham_rdpu_personal_tranche3[$i]=0.13; //Read korelasi saham - rdpu
  $korel_saham_rdcampuran_personal_tranche3[$i]=0.13; //Read korelasi saham - rdsaham
  
  $korel_fi_depo_personal_tranche3[$i]=0.13; //Read korelasi fi - deposito
  $korel_fi_rdsaham_personal_tranche3[$i]=0.13; //Read korelasi fi - rdsaham
  $korel_fi_rdfi_personal_tranche3[$i]=0.13; //Read korelasi fi - rdfi
  $korel_fi_rdpu_personal_tranche3[$i]=0.13; //Read korelasi fi - rdpu
  $korel_fi_rdcampuran_personal_tranche3[$i]=0.13; //Read korelasi fi - rdsaham
  
  $korel_depo_rdsaham_personal_tranche3[$i]=0.13; //Read korelasi depo - rdsaham
  $korel_depo_rdfi_personal_tranche3[$i]=0.13; //Read korelasi depo - rdfi
  $korel_depo_rdpu_personal_tranche3[$i]=0.13; //Read korelasi depo - rdpu
  $korel_depo_rdcampuran_personal_tranche3[$i]=0.13; //Read korelasi depo - rdsaham
  
  $korel_rdsaham_rdfi_personal_tranche3[$i]=0.13; //Read korelasi rdsaham - rdfi
  $korel_rdsaham_rdpu_personal_tranche3[$i]=0.13; //Read korelasi rdsaham - rdpu
  $korel_rdsaham_rdcampuran_personal_tranche3[$i]=0.13; //Read korelasi rdsaham - rdsaham

  $korel_rdfi_rdpu_personal_tranche3[$i]=0.13; //Read korelasi rdfi - rdpu
  $korel_rdfi_rdcampuran_personal_tranche3[$i]=0.13; //Read korelasi rdfi - rdsaham
  
  $korel_rdpu_rdcampuran_personal_tranche3[$i]=0.13; //Read korelasi rdpu - rdsaham
